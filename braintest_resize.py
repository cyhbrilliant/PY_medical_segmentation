...
# num = np.loadtxt("E:/zhangjinjing/brain2D/index.txt", dtype=int)
...
# for j in range(110):
#         dict[j + 1] = num[0, j]
# for zip_num in range(26):
#     TestPath = 'Testing/' + str(zip_num+85)
...
#     saver.restore(sess,'E:/zhangjinjing/brain2D/brain_session_HLGG/brain_session_resize_5.ckpt')
...
sess=tf.Session(config=config)
saver = tf.train.Saver()
saver.restore(sess,'E:/zhangjinjing/brain2D/brain_session_HLGG/brain_session_resize_8.ckpt')
